...
class Application(Frame):
    ...
    def __init__(self, master):
        ...
        self.info = Label(self, text='', bg='gray',
                          font=('Times', '16'), padx=0, pady=0, width=1,
                          borderwidth=3, relief=RIDGE)
        self.info.grid(row=0, column=0, columnspan=1,
                       sticky=N + E + W + S)
        ...
        self.quit = Button(self, text='QUIT', fg='gray51',
        ...
        self.rabbit = Label(self, text='\u23f4',
                            bg='black', fg='white', font=('Times', '30', 'bold'),
                            padx=0, pady=0, width=1, borderwidth=3, relief=RIDGE)
